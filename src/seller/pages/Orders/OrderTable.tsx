...
import { OrderStatus as OrderStatusConst } from '../../../types/orderTypes';
...
const orderStatus: Array<{ color: string; label: OrderStatus }> = [
  { color: '#FFA500', label: OrderStatusConst.PENDING }, 
  { color: '#F5BCBA', label: OrderStatusConst.PENDING }, 
  { color: '#F5BCBA', label: OrderStatusConst.PENDING },
  { color: '#1E90FF', label: OrderStatusConst.SHIPPED }, 
   { color: '#32CD32', label: OrderStatusConst.DELIVERED }, 
   { color: '#FF0000', label: OrderStatusConst.CANCELLED },
